package com.zero.accessdb.controller;
...
public class AccessDatabaseController {
	 ...
	 * @param file	Access database file
	 * @param tableName	Table name to query
	 * @return	Query results
	 */
	@PostMapping("/upload")
    public List<Map<String, Object>> uploadAndQuery(@RequestParam("file") MultipartFile file, @RequestParam("tableName") String tableName) {
